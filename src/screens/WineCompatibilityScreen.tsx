...
type WineCompatibilityRouteProp = RouteProp<
  RootStackParamList,
  "WineCompatibility"
>;
...
const WineCompatibilityScreen = () => {
  ...
  const getOverallFeedback = (score: number) => {
    if (score >= 90)
      return t("wineCompatibility.feedback.excellent", { nickname });
  ...
  const detailsAnims = useRef(
    result ? result.details.map(() => new Animated.Value(0)) : []
  ).current;
    ...
    return (
      <View style={styles.loadingContainer}>
        ...
        <Text style={styles.loadingText}>
          ...
          {"\n"}
          {t("wineCompatibility.loading", { nickname })}
          {loadingDots}
        </Text>
      </View>
    );
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        <GlassHeader
          floating={false}
          title={t("wineCompatibility.headerTitle")}
        />
        ...
        <View style={styles.mainContainer}>
          ...
          >
            <Text style={styles.reportTitle}>
              ...
              {t("wineCompatibility.questionTitle")}
            </Text>
          </Animated.View>
          ...
          <View style={styles.conversationSection}>
            <View style={styles.bubbleContainer}>
              <Animated.View
                style={[styles.scoreRow, { opacity: scoreOpacity }]}
              >
                <Text
                  style={[
                    styles.scoreBigText,
                ...
                <Text style={styles.scoreUnitText}>
                  {t("wineCompatibility.scoreUnit")}
                </Text>
              </Animated.View>
              <Text style={styles.bubbleText}>{displayedFeedback}</Text>
          ...
          {result && (
            <Animated.View
              style={[
                ...
                { opacity: detailsContainerOpacity },
              ]}
            >
        ...
        <View style={styles.bottomContainer}>
          ...
          >
            <Text style={styles.ctaButtonText}>
              {t("wineCompatibility.confirmButton")}
            </Text>
          </TouchableOpacity>
        </View>
      </View>
